...
- ✅ **Продвинутый алгоритм коррекции дуг 180°** - решает проблему, которой страдают 90% всех постпроцессоров
...
├── README.md                          # Этот файл
├── ARC_180_CORRECTION_ALGORITHM.md   # Алгоритм коррекции дуг 180° (универсальное решение)
...
- **[ARC_180_CORRECTION_ALGORITHM.md](ARC_180_CORRECTION_ALGORITHM.md)** - Универсальный алгоритм коррекции дуг 180° для постпроцессоров
  - Решает проблему, которой страдают 90% всех постпроцессоров
  - Подробное описание проблемы и решения
  - Может быть применен в других программах
